...
// export const getByPaths = <R extends T.Root, S, Deps>(
//   root: R,
...
// type RetrieveItemDetailsInFolder<S, Deps> = {
//   retrieveItemDetailsInFolders: <R extends T.Root>(
//     drivewsids: [R['drivewsid'], ...T.NonRootDrivewsid[]],
//   ) => XXX<S, Deps, [O.Some<R>, ...O.Option<T.NonRootDetails>[]]>
// }

// export const getByPathsC = <R extends T.Root, S, Deps>(
//   paths: NEA<NormalizedPath>,
...
//  */
// const validateCachedHierarchies = <R extends T.Root, S, Deps>(
...
//     SRTE.chain(() =>
//       pipe(
//         SRTE.ask<S, RetrieveItemDetailsInFolder<S, Deps>>(),
//         SRTE.chainW(
//           (env: RetrieveItemDetailsInFolder<S, Deps>) =>
//             env.retrieveItemDetailsInFolders<R>(
//               [
