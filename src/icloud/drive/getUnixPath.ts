...
import * as Cache from '../drive/cache/cachef';

// export const getUnixPath = (
//     cache: Cache.ICloudDriveCache,
...
//         name: ""
//     }
// ): TE.TaskEither<Error, { session: ICloudSessionState; details: DriveDetailsFolder; cache: Cache.ICloudDriveCache }> => {
...
//             return TE.of({ session, details: item, cache: Cache.putItem(item)(cache) });
//         })
//     );
// };
