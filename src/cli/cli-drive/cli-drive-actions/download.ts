...
import { flattenFolderTreeWithPath } from '../../../icloud/drive/drive-query/methods/drive-get-folders-trees'
...
const downloadRecursive = (argv: RecursiveArgv): XXX<DriveQuery.State, Deps, string> => {
...
): XXX<DriveQuery.State, Deps & R, string> => {
  const verbose = dry
